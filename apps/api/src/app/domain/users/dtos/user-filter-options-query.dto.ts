...
export class UserFilterOptionsQueryDTO {
  @ApiPropertyOptional({ description: 'Search term for assignee names or email', example: 'john' })
  ...
  @ApiPropertyOptional({
    description: 'Maximum number of assignees to return',
    minimum: 1,
